...
@group(0) @binding(0) var<uniform> u_view_uniform: ViewUniform;
@group(1) @binding(0) var<uniform> u_transform_uniform: TransformUniform;
...
@group(2) @binding(0) var<uniform> u_light: PointLight;
@group(3) @binding(0) var<uniform> u_material: PhongMaterial;
@group(4) @binding(0) var<uniform> u_camera_pos: vec4<f32>;
